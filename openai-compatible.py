...
from ollamahelpers.manager import OllamaServerCtx, get_url
...
def main(
    ...
    try:
        ...
        with OllamaServerCtx(host=server, stop=stop):
            ...
            url = f'{get_url(server, defaults.PORT)}/v1'
            ...
            print(response.choices[0].message.parsed.model_json_schema())
            print(Answer.model_validate(response.choices[0].message.parsed))
